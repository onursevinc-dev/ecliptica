...
export default function RobotModel(props) {
  ...
  return (
    <group ref={modelRef} {...props} dispose={null} position={[0, -0.5, 0]} scale={[0.004, 0.004, 0.004]} rotation={[0.2, 0.5, 0]}>
      <mesh name="polySurface206_M_Board_blinn_0" castShadow receiveShadow geometry={nodes.polySurface206_M_Board_blinn_0.geometry} material={materials.M_Board_blinn} />
      <mesh name="polySurface206_M_Board_Blinn_Second_0" castShadow receiveShadow geometry={nodes.polySurface206_M_Board_Blinn_Second_0.geometry} material={materials.M_Board_Blinn_Second} />
      ...
      />
      <mesh name="polySurface206_pasted__M_Boss_Blinn1_0" castShadow receiveShadow geometry={nodes.polySurface206_pasted__M_Boss_Blinn1_0.geometry} material={materials.pasted__M_Boss_Blinn1} />
    </group>
  );
}
